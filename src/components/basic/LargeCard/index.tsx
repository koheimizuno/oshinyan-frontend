...
const LargeCard =  ({
    ...
    return (
      <>
        <>
          <div className=" w-full h-[400px] mb-[15px] hover:opacity-70 flex">
            {/* <div className="relative w-full h-full w-[50%] bg-[url('/assets/imgs/cats/top_cat.png')] bg-center" style={{backgroundImage: "url('/assets/imgs/cats/top_cat.png')"}}>
            </div> */}
            <div className=" px-[16px]  bg-white h-full w-[50%]">
              <div>
